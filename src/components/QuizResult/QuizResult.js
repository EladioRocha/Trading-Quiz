      ...
      <main className="w-100 h-100 bg-blue-dark">
        ...
        <section className="h-33 center-xy">
          <div className="w-85 h-100">
            ...
            <ons-row>
              <p className="txt-center w-100 rubik-regular txt-gray fs-15px m-0 p-0">You win the forex quiz. You earned 100 coins</p>
            </ons-row>
          </div>
        </section>
        <section className="h-33 center-xy">
          <div className="w-85 h-100">
            ...
            <div className="w-100 center-x mt-10px">
              <Link className="w-100" to={"/Quizes"}>
                <Button className="hover-btn round-30px" modifier="large--cta">Take New Quiz</Button>
              </Link>
            </div>
          </div>
        </section>
